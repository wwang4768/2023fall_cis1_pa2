...
def main(): 
    ...
    choose_set = 'a'
    #base_path = os.path.join(dirname, 'pa1_student_data\\PA1 Student Data\\pa1-unknown-')
    base_path = os.path.join(dirname, 'pa1_student_data\\PA1 Student Data\\pa1-debug-')
